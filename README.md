...
```
(CMD)
git clone https://github.com/stormleshrac/xector.git 
git init
git add .
git commit -m "OK"
...
[![Heroku Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/stormleshrac/xector.git)
